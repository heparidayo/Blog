...
title: '[UE5/System] 언리얼 엔진 데이터 관리 및 시스템 구조 (Serialization, Asset, Module)'
published: 2026-02-14
description: 'C++ 직렬화, UPackage를 이용한 에셋 관리 전략, 그리고 언리얼의 모듈과 플러그인 빌드 시스템 구조까지 알아보자'
image: ''
...
* **에셋 (Asset):** 패키 내부에 포함된 오브젝트 중 **에디터 콘텐츠 브라우저에 노출되는 메인 오브젝트**이다.
